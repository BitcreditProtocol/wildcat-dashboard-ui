      ...
      {clowderLoading ? (
        ...
        <div className="flex flex-col gap-4">
          <InfoField
            ...
            copyLabel={intl.formatMessage({ id: "home.clowder.nodeIdLabel", defaultMessage: "Clowder Node ID" })}
            mono
          />
          <InfoField
            label={<FormattedMessage id="home.clowder.version" defaultMessage="Version" />}
            value={clowderData.version}
          />
          <InfoField
            label={<FormattedMessage id="home.clowder.network" defaultMessage="Network" />}
            value={clowderData.network}
          />
          <InfoField
            label={<FormattedMessage id="home.clowder.changeAddress" defaultMessage="Change Address" />}
            value={clowderData.change_address}
            copyLabel={intl.formatMessage({ id: "home.clowder.changeAddress", defaultMessage: "Change Address" })}
            mono
          />
