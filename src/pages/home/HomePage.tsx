                  ...
                  <div className="flex flex-col gap-1">
                    <div className="flex items-center">
                      ...
                      <CopyButton
                        ...
                        label={intl.formatMessage({ id: "home.identity.nodeId", defaultMessage: "Node ID" })}
                      />
                    </div>
              ...
              <div className="flex flex-col gap-1">
                <div className="flex items-center">
                  ...
                  <CopyButton
                    ...
                    label={intl.formatMessage({ id: "home.clowder.nodeIdLabel", defaultMessage: "Clowder Node ID" })}
                  />
                </div>
                <span className="font-mono text-sm break-all bg-muted p-2 rounded text-muted-foreground">
              ...
              <div className="flex flex-col gap-1">
                <div className="flex items-center">
                  ...
                  <CopyButton
                    ...
                    label={intl.formatMessage({ id: "home.clowder.changeAddress", defaultMessage: "Change Address" })}
                  />
                </div>
                <span className="font-mono text-sm break-all bg-muted p-2 rounded text-muted-foreground">
